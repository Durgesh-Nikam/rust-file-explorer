...
// New IPC functions for copy, cut, paste operations
export const copyFile = async (
  sourcePath: string,
  destinationPath: string
): Promise<void> => {
  return invoke<void>("copy_file", { sourcePath, destinationPath });
};
...
export const copyDirectory = async (
  ...
  return invoke<void>("copy_directory", { sourcePath, destinationPath });
};
...
export const moveFile = async (
  ...
  return invoke<void>("move_file", { sourcePath, destinationPath });
};
...
export const moveDirectory = async (
  ...
  return invoke<void>("move_directory", { sourcePath, destinationPath });
};
